...
import io.github.xhinliang.material.widget.DatePicker;
import io.github.xhinliang.material.widget.YearPicker;
...
public class DatePickerDialog extends Dialog {
    ...
    public static class Builder extends Dialog.Builder  {
        ...
        @NonNull
        private OnDateChangedListener getOnDateChangedListener() {
        ...
        public DatePickerDialog build(Context context) {
            return (DatePickerDialog) super.build(context);
        }
    }
