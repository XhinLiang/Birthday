package io.github.xhinliang.material.dialog;
...
import io.github.xhinliang.material.drawable.BlankDrawable;
import io.github.xhinliang.material.drawable.RippleDrawable;
import io.github.xhinliang.material.util.ThemeUtil;
import io.github.xhinliang.material.util.ViewUtil;
import io.github.xhinliang.material.widget.Button;
import io.github.xhinliang.material.widget.TextView;
...
public class Dialog extends android.app.Dialog {
     ...
     *
     * @param width The size value in pixels.
     * @return The Dialog for chaining methods.
     */
    public Dialog dividerHeight(int width) {
        mCardView.setDividerHeight(width);
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public Dialog positiveAction(CharSequence action, final Action1 callback) {
        mPositiveAction.setText(action);
        mPositiveAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (callback != null)
                    callback.onAction(Dialog.this);
                if (autoDismiss)
                    Dialog.this.dismiss();
            }
        });
    ...
    public Dialog setAutoDismiss(boolean autoDismiss) {
     ...
     * @return The Dialog for chaining methods.
     */
    public Dialog positiveAction(int id, Action1 callback) {
        return positiveAction(id == 0 ? null : getContext().getResources().getString(id), callback);
    }
    ...
    public Dialog positiveActionBackground(int id) {
        return positiveActionBackground(id == 0 ? null : getDrawable(id));
    }
    ...
    public Dialog positiveActionTextAppearance(int resId) {
        mPositiveAction.setTextAppearance(resId);
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public Dialog negativeAction(CharSequence action, final Action1 callback) {
     ...
     * @return The Dialog for chaining methods.
     */
    public Dialog negativeAction(int id, Action1 callback) {
        return negativeAction(id == 0 ? null : getContext().getResources().getString(id), callback);
    }
    ...
    public Dialog negativeActionBackground(int id) {
        return negativeActionBackground(id == 0 ? null : getDrawable(id));
    }
    ...
    public Dialog negativeActionTextAppearance(int resId) {
        mNegativeAction.setTextAppearance(resId);
        return this;
    }
     ...
     * @return The Dialog for chaining methods.
     */
    public Dialog neutralAction(CharSequence action, final Action1 callback) {
     ...
     * @return The Dialog for chaining methods.
     */
    public Dialog neutralAction(int id, Action1 callback) {
        return neutralAction(id == 0 ? null : getContext().getResources().getString(id), callback);
    }
    ...
    public Dialog neutralActionBackground(int id) {
        return neutralActionBackground(id == 0 ? null : getDrawable(id));
    }
    ...
    public Dialog neutralActionTextAppearance(int resId) {
        mNeutralAction.setTextAppearance(resId);
        return this;
    }
    ...
    private class DialogCardView extends CardView {
        ...
        public void setDividerHeight(int width) {
    ...
    public static class Builder implements DialogFragment.Builder {
        ...
        public Builder positiveAction(CharSequence text, Action1 callback) {
            mPositiveText = text;
            onPositive = callback;
            return this;
        }

        public Builder negativeAction(CharSequence text, Action1 callback) {
            mNegativeText = text;
            onNegative = callback;
            return this;
        }

        public Builder neutralAction(CharSequence text, Action1 callback) {
            mNeutralText = text;
            onNeutral = callback;
            return this;
        }

        public Builder onDismiss(Action1 callback) {
        ...
        public Dialog build(Context context) {
            Dialog mDialog = onBuild(context, mStyleId);

            mDialog.title(mTitle)
                    .positiveAction(mPositiveText, onPositive)
                    .negativeAction(mNegativeText, onNegative)
                    .neutralAction(mNeutralText, onNeutral)
            ...
            if (onDismissCallback != null)
                mDialog.setOnDismissListener(new OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        onDismissCallback.onAction((Dialog) dialog);
                    }
                });
