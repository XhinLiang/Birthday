...
import io.github.xhinliang.material.widget.CircleCheckedTextView;
import io.github.xhinliang.material.widget.TimePicker;
...
public class TimePickerDialog extends Dialog {
    ...
    public static class Builder extends Dialog.Builder  {
        ...
        protected Dialog onBuild(Context context, int styleId) {
            ...
            OnTimeChangedListener listener = getOnTimeChangedListener();
